            ...
            <div className="d-flex gap-2">
              <div className="edit">
                <Button
                  variant="ghost-info"
                  size="sm"
                  className="btn-ghost-info btn-icon edit-item-btn"
                >
                  <i className="ph-pencil-line"></i>
                </Button>
              </div>
          ...
          <Row>
            ...
            <Col xxl={3} md={6}>
              <Card className="card-height-100 bg-success-subtle border-0 overflow-hidden">
                ...
                <Card.Body className="p-4 z-1 position-relative">
                  <h4 className="fs-22 fw-semibold mb-3">
                    <CountUp end={559.25} decimals={2} suffix="k" />
                  </h4>
                  <p className="mb-0 fw-medium text-uppercase fs-14">
                    Active Users
                  </p>
                    ...
                    <div className="d-flex align-items-center gap-3">
                      ...
                      <div className="flex-grow-1">
                        <Link to="#" className="stretched-link">
                          <h6 className="fs-17">
                            Invite your friends to Toner
                          </h6>
                        </Link>
                        <p className="text-muted mb-0">
                          Nor again is there anyone pursues
                        </p>
                      </div>
                    </div>
                  </div>
