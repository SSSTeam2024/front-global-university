      ...
      <Row>
        <Col lg={4}>
          ...
          <p className="text-muted mb-lg-0">
            Personal Identifiable Information (PII) is defined as: Any
                ...
                <Col lg={4}>
                  <div>
                    ...
                    <Form.Control
                      ...
                      defaultValue="+(235) 01234 5678"
                    />
                  </div>
                </Col>
                <Col lg={4}>
                  <div>
                    <Form.Label htmlFor="birdthdatInput">
                      Joining Date
                    </Form.Label>
                    {/* <Flatpickr
                ...
                <Col lg={6}>
                  <div>
                    ...
                    <Form.Control
                      ...
                      defaultValue="Sales & Marketing Manager"
                    />
                  </div>
                </Col>
                <Col lg={6}>
