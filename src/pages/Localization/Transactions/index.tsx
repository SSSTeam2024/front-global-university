    ...
    case "American Express":
      return (
        <img
          src={americanExpress}
          alt=""
          className="avatar-xs object-fit-cover paycard-image"
        />
      );
    case "Discover":
      return (
            ...
            <Modal.Body className="p-4">
              <Form className="tablelist-form">
                <Row>
                  ...
                  <Col lg={12}>
                    <div className="mb-3">
                      <Form.Label htmlFor="clientName-field">
                        Client Name
                      </Form.Label>
                      <Form.Control
                        type="text"
                  ...
                  <Col lg={6}>
                    <div className="mb-3">
                      <Form.Label htmlFor="transactionID-field">
                        Transaction ID
                      </Form.Label>
                      <Form.Control
                        type="text"
                        id="transactionID-field"
                        placeholder="#TBSC320003205"
                        required
                      />
                    </div>
                  </Col>
                  ...
                  <Col lg={6}>
                    <div className="mb-3">
                      <Form.Label htmlFor="paymentMethod-field">
                        Payment Method
                      </Form.Label>
                      <select
                      ...
                      >
                        ...
                        <option value="Visa Credit/Debit">
                          Visa Credit/Debit
                        </option>
                      </select>
                    </div>
