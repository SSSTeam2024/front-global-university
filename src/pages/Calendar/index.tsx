          ...
          <Row>
            ...
            <Col xl={3}>
              <Button
                ...
                onClick={toggle}
              >
                <i className="mdi mdi-plus"></i> Create New Order
              </Button>
              <div className="mt-4">
              ...
              <Card className="bg-primary-subtle border-0 overflow-hidden">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        ...
                        ></stop>
                        <stop
                          stopColor="rgba(var(--tb-primary-rgb), 0.2)"
                          offset="1"
                        ></stop>
                      </linearGradient>
                      <linearGradient
                ...
                <Card.Body className="p-4 z-1 position-relative">
                  <h5 className="mb-3 lh-base">
                    You have got <span className="text-primary">400 bonus</span>{" "}
                    points. Feel free to use them in your Orders
                  </h5>
                  <Link
                    to="/orders-list-view"
          ...
          >
            ...
            <Row className="event-form">
              ...
              <Col className="col-12">
                <div className="mb-3">
                  <label className="form-label" htmlFor="event-payment">
                    Payment ($)
                  </label>
                  <div>
                    <Form.Control
            ...
            <div className="hstack gap-2 justify-content-end">
              ...
              {isEditButton && (
                <Button variant="success" type="submit" id="btn-save-event">
                  {" "}
