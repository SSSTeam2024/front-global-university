    ...
    () => [
      {
        ...
        accessor: (cellProps: any) => {
          return <h5 className="mb-0 fs-16">{cellProps.discount}</h5>;
        },
      },
      {
        Header: "Coupon Title",
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumb title="Coupons" pageTitle="More" />
          <div id="couponsList">
            <Row>
              <Col xxl={12}>
                <Card>
            ...
            <Modal.Body className="p-4">
              <Form className="tablelist-form">
                <Row>
                  ...
                  <Col lg={12}>
                    <div className="mb-3">
                      <Form.Label htmlFor="couponTitle">
                        Coupon Title
                      </Form.Label>
                      <Form.Control
                        type="text"
                  ...
                  <Col lg={6}>
                    <div className="mb-3">
                      <Form.Label htmlFor="ProductSelect">
                        Product Type
                      </Form.Label>
                      <select
                  ...
                  <Col lg={6}>
                    <div className="mb-3">
                      <Form.Label htmlFor="amountPercentage">
                        Amount/Percentage
                      </Form.Label>
                      <Form.Control
                        type="text"
