...
const SimplePie = ({ dataColors }: any) => {
    ...
    var options: any = {
        ...
        labels: ['Professeur', 'Maitre assistant', 'Maitre de conférences', 'Assistant'],
        legend: {
            position: 'bottom'
        },
        dataLabels: {
...
const SimpleDonut = ({ dataColors }: any) => {
    ...
    const series = [44, 55, 41, 17, 15, 8]
    var options: any = {
        chart: {
            height: 300,
            type: 'donut',
        },
        labels: ['Contractuel Doctorant', 'Contractuel Docteur', 'Vacataire', 'Expert', 'Artisant', 'Coach'],
        legend: {
            position: 'bottom'
        },
        dataLabels: {
