                ...
                <div className="d-flex align-items-center gap-3 mb-4 mt-3 mt-xxl-0">
                  ...
                  <Dropdown className="flex-shrink-0">
                    <Dropdown.Toggle
                      ...
                      href="#"
                      className="text-reset dropdown-btn d-inline-block"
                    >
                ...
                <Card className="mt-4 mb-0 bg-info-subtle border-0">
                  <Card.Body>
                    ...
                    <p className="text-muted">
                      Hey! Awesome products! Can you share the best product name
                      ?
                    </p>
                    <Link to="/statistics" className="btn btn-info btn-sm">
                      See Report{" "}
          ...
          <Card.Body className="d-flex justify-content-between align-items-center z-1">
            <div className="d-flex align-items-center gap-3">
              ...
              <div className="flex-grow-1">
                <h5 className="card-title fw-medium fs-17 mb-1">
                  Have you tried new <b>Toner eCommerce Templates</b> ?
                </h5>
                <p className="mb-0">
                  That allows customers to browse and purchase items from an
                  online store.
                </p>
              </div>
            </div>
