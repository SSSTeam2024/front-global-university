      ...
      <Col xxl={3} lg={6}>
        <Card>
          <Card.Header className="d-flex">
            <h5 className="card-title flex-grow-1 mb-0">Filtrage par Grade</h5>
          ...
          <Card.Body className="px-0">
            <SimpleBar style={{ maxHeight: "415px" }}>
              <div className="vstack gap-3 px-3">
                {(productDelivery || []).map((item: any, key: any) => (
                  <div className="p-3 border border-dashed rounded-3" key={key}>
                    <div className="d-flex align-items-center gap-2">
                      ...
                      <div className="flex-grow-1">
                        ...
                        <p className="mb-0">
                          by:{" "}
                          <span className="text-info">{item.productBy}</span>
                        </p>
                      </div>
...
export default GradeEnseignant;
